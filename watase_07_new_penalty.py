...
# シミュレーションを行う関数（実行可能最良解を別途記録する最終版）
def simulation(Graph, gen, par, delay_multiplier=1.5, use_penalty_method=True): # デフォルトでペナルティ法を有効に
    ...
    # グラフが連結でない場合に備えて、接続されているノードペアを選択
    ...
    # 戻り値を gBest_feasible のものに変更
    return gBest_feasible_bn, bn_inv, gBest_feasible_delay, mod_dijkstra_bn, label_correcting_bn, pso_time, lc_time # 修正後 (7つの値)###############
### main関数 ###
###############
