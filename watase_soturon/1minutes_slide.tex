...
\begin{frame}[t]
    ...
    \vspace{-0.7cm}
    \begin{center}
        {\large \textcolor{TextBlack}{C\hspace{0.09em}-18 Restart PSO：ボ\hspace{0.1em}ト\hspace{0.01em}ルネックリンク帯域最大化を\\目的とした
    ...
    \begin{columns}[T, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            % 図1
            \includegraphics[width=1.0\linewidth, keepaspectratio]{images/20260210.pdf}
            \vspace{0.1cm} 
            % 図2
