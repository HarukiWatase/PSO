...
SUMMARY_CSV = '20251208_161535_restart_summary.csv'
GENERATION_LOG_CSV = '20251208_161535_restart_generation_log.csv'
...
# 出力する画像ファイル名
OUTPUT_IMAGE_NAME = f'restart13par100_{NODE_TO_PLOT}_xlim{X_AXIS_LIMIT}.png'
# --- 設定ここまで ---
