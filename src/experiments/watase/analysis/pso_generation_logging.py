"""PSO baseline variant with per-generation logging output.

This file is migrated from `watase_26.py`. It keeps the optimization logic close
to the baseline and changes the logging granularity from improvement events to
per-generation snapshots for easier analysis/plotting.
"""
...
def simulation(Graph, src, dst, constraints, pso_params):
    """Run one experiment and return generation-level PSO tracking data."""
